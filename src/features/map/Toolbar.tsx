...
export default function Toolbar({ state, onChange }: Props) {
  return (
    <div className="cs-absolute cs-left-4 cs-top-4 cs-z-[500] cs-flex cs-w-[min(92vw,680px)] cs-flex-wrap cs-items-end cs-gap-2 cs-rounded-2xl cs-border cs-bg-white cs-p-3 cs-shadow">
      {/* Suche */}
      ...
      <button
        ...
        onClick={() =>
          onChange({ query: "", vacant: "all", reuse: "all" })
        }
      >
        Reset
      </button>
